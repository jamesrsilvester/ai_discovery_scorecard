    ...
    return (
        <header className="flex items-center justify-between px-6 py-4 bg-white border-b border-slate-200">
            ...
            <div className="flex items-center gap-3">
                <Link href="/test-live">
                    <button className="flex items-center gap-2 px-3 py-2 text-sm font-medium text-white bg-indigo-600 border border-indigo-600 rounded-lg hover:bg-indigo-700 shadow-sm transition-colors">
